          ...
          child: Column(
            children: [
              ...
              LottieBuilder.asset(
                ...
                width: 100.446 * SizeConfig.widthMultiplier,
              ),
              SizedBox(
  ...
  return AppBar(
    ...
    actions: [
      Image.asset(
        ...
        width: 12.2767 * SizeConfig.widthMultiplier,
      ),
      SizedBox(
