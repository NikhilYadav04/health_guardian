              ...
              child: Column(
                children: [
                  ...
                  Container(
                    padding: EdgeInsets.symmetric(
                        horizontal: 4.4642 * SizeConfig.widthMultiplier,
                        vertical: 2.633427 * SizeConfig.heightMultiplier),
                    height: (SizeConfig.heightMultiplier <= 8.3 &&
                            SizeConfig.widthMultiplier <= 5.12)
                        ? 45* SizeConfig.heightMultiplier
                        : 42.134846 * SizeConfig.heightMultiplier,
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(
                          0.526687 * SizeConfig.heightMultiplier),
                    ),
                    child: Column(
                      children: [
                        ...
                        SizedBox(
                          height: 2.949448 * SizeConfig.heightMultiplier,
                        ),
                        ...
                        buttonsDetail("Set Reminder", () {
                          reminderController.setReminder(context);
                            ...
                            Colors.white,
                            5.793559 * SizeConfig.heightMultiplier,
                            40.178571 * SizeConfig.widthMultiplier,
                            3.160123 * SizeConfig.heightMultiplier)
                      ],
                    ),
                  )
                ],
